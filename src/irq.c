...
// According to the Programming Manual, the vector table must be aligned to at
// least 128 words Which is 512 bytes for a 32-bit word
...
void irq_init() { SCB->VTOR = (uint32_t)vector_table; }